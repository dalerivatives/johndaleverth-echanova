# Deploy v83 on your existing Render service
...
terminal text and World Chat need a supported male browser voice in static mode.
If no recognized male voice is installed, dynamic speech remains unavailable;
the application does not substitute a female/default voice.
